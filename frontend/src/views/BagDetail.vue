        ...
        <div class="arrow-inner">
          <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="24px" height="24px">
            ...
            <path class="arrow-path" fill="white" filter="url(#arrowShadow)" 
                  d="M15.5,16.5 L11.5,12.5 L15.5,8.5 C15.8,8.2 16.3,8.2 16.6,8.5 C16.9,8.8 16.9,9.3 16.6,9.6 L13.2,13 L16.6,16.4 C16.9,16.7 16.9,17.2 16.6,17.5 C16.3,17.8 15.8,17.8 15.5,17.5 L15.5,16.5 Z"/>
          </svg>
        </div>
      </div>
      ...
      <div class="arrow-nav right" @click="nextImage">
        <div class="arrow-inner">
          <svg class="arrow-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" width="24px" height="24px">
            ...
            <path class="arrow-path" fill="white" filter="url(#arrowShadow)" 
                  d="M8.5,16.5 L12.5,12.5 L8.5,8.5 C8.2,8.2 7.7,8.2 7.4,8.5 C7.1,8.8 7.1,9.3 7.4,9.6 L10.8,13 L7.4,16.4 C7.1,16.7 7.1,17.2 7.4,17.5 C7.7,17.8 8.2,17.8 8.5,17.5 L8.5,16.5 Z"/>
          </svg>
        </div>
      </div>
    </div>
